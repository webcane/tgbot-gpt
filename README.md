...
### params
If some env variables need to be updated, use `params` terraform module to upload env variables into AWS SSM Parameter Store.
1. Init terraform script
    ```bash
    cd ./ci/aws/params
    terraform init -reconfigure \
...
- Current setup uses [t3.small](https://eu-central-1.console.aws.amazon.com/ec2/home?region=eu-central-1#InstanceTypes:v=3;search=:t3.small) ec2 instance type (2GiB Memory, 2 vCPU). This is not free tier eligible
