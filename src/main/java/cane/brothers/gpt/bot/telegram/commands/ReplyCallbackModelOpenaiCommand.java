...
import static cane.brothers.gpt.bot.telegram.commands.ReplyCallbackModelOpenaiCommand.NAME;

@Slf4j
@Component(NAME)
@RequiredArgsConstructor
class ReplyCallbackModelOpenaiCommand implements ChatCommand<CallbackQuery>, Utils {
    public final static String NAME = "/callback_model_openai";
    private final static GptModel model = GptModel.OPENAI;
