...
output "aws_ec2_iam_instance_profile_arn" {
  value = module.tgbot-ec2.iam_instance_profile_arn
}

output "aws_ec2_iam_role_name" {
  value = module.tgbot-ec2.iam_role_name
}

output "aws_ec2_iam_role_arn" {
  value = module.tgbot-ec2.iam_role_arn
}
